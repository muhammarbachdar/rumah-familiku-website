...
export function VillaDetail({ property, availabilityData, availabilityLoading, bookedDates, siteData, activePromo, displayPromoTitle, locale }: SimplePropertyDetailProps) {
