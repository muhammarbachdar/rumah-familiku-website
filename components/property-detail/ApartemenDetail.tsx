...
interface SimplePropertyDetailProps {
  property: any;
...
export function ApartemenDetail({ property, availabilityData, availabilityLoading, bookedDates, siteData, activePromo, displayPromoTitle, locale }: SimplePropertyDetailProps) {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* ===== AVAILABILITY SECTION - collapse di balik CTA ===== */}
            <div className="mt-8">
              {!showAvailability ? (
                <button
                ...
                <div>
                  ...
                  {availabilityLoading ? (
                    <p className="text-gray-text">Memuat data ketersediaan...</p>
                  ) : (
